  ...
  const handlepopup=()=>{
    ...
    <div className='InvoiceData-wrapper'>
      <div className='InvoiceData-sidebar'> 
           <DashBoardSideBar dashboardboolean={false} createinvoiceboolean={true} />
      </div>
       ...
       <div className='InvoiceData-heading-main'>
             ...
             <div className='InvoiceData-form-1-wrapper'> 
                  <div className='InvoiceData-form-header'> 
                    <div className='Header-left-side'> 
                     <img src={officepaylogosecond}/>
                     <h5>816, shekher center, palasia Square, Indore, India 452018 </h5> 
                     </div>
                 ...
                 <div className='Bill-Details'> 
                    ...
                    <table className='InvoiceData-BillDetails-table'> 
                        ...
                        <tbody> 
                          <tr> 
                              <td className='address-col'> <p> 101, Shekher Center, A.B. Road, Indore, (M.P.) 452018 </p></td>
                    ...
                    <table className='table-total'> 
                       <thead className='table-two-thead'> 
                        ...
                        <tbody> 
                           <tr> 
                              <td className='first-col-secondtable paddingtop'> Rent for December Office no. 101 </td>
          ...
          <div className='InvoiceData-form-2-wrapper'> 
            ...
            <div className='form-2-inner-wrapper'> 
             ...
             <div> 
             <ul>
              <li className='Download-li'> <img src={DownloadIcon}/> Download</li>
              <li className='Delete-li'> <img src={DeleteIcon}/> Delete</li> 
            </ul>
            </div> 
            </div>
          </div>
         ...
         { popupvalue ? <Popuptwo closePopup={handlepopup} text="Invoice Downloaded Successfully."/> :null}
    </div>
  )
}
